      ...
      <div className={styles.infoUpdateContainer}>
        ...
        <div className={styles.updateContainer}>
          <div className={styles.inputInfo6}>
            <label className={styles.labelStyle}><input type="radio" name="compulsory" value="major_compulsory"
              checked={selectedSubjectType === "major_compulsory"}
              onChange={() => setselectedSubjectType("major_compulsory")} />
              전공 필수 과목</label>
            <label className={styles.labelStyle}><input type="radio" name="compulsory" value="liberal_compulsory"
